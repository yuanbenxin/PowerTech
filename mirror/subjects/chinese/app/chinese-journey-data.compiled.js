...
(() => {
  ...
  const JOURNEY_TO_THE_WEST_CARDS = [{
    id: 'xiyouji_01',
    title: '第 1—7 回 · 大圣出世与大闹天宫',
    chapterRange: '第 1—7 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_01/index.html',
    ...
    id: 'xiyouji_02',
    title: '第 8—12 回 · 取经缘起与唐僧身世',
    chapterRange: '第 8—12 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_02/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['如来', '观音', '唐僧身世'],
    ...
    id: 'xiyouji_03',
    title: '第 13—15 回 · 踏上西行与白龙马',
    chapterRange: '第 13—15 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_03/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['唐僧', '白龙马', '西行起点'],
    ...
    id: 'xiyouji_05',
    title: '第 24—26 回 · 偷吃人参果',
    chapterRange: '第 24—26 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_07',
    title: '第 32—35 回 · 莲花洞斗金角银角',
    chapterRange: '第 32—35 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_08',
    title: '第 40—42 回 · 大战红孩儿',
    chapterRange: '第 40—42 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_09',
    title: '第 45—46 回 · 车迟国斗法',
    chapterRange: '第 45—46 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_10',
    title: '第 54—55 回 · 女儿国与蝎子精',
    chapterRange: '第 54—55 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_11',
    title: '第 56—58 回 · 真假美猴王',
    chapterRange: '第 56—58 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_12',
    title: '第 59—61 回 · 三调芭蕉扇',
    chapterRange: '第 59—61 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_13',
    title: '第 65—66 回 · 小雷音寺降黄眉',
    chapterRange: '第 65—66 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_14',
    title: '第 72—73 回 · 盘丝洞斗蜘蛛精',
    chapterRange: '第 72—73 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    id: 'xiyouji_15',
    title: '第 74—77 回 · 狮驼岭三魔',
    chapterRange: '第 74—77 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_15/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['狮驼岭', '青狮白象', '大鹏'],
    ...
    id: 'xiyouji_16',
    title: '第 81—83 回 · 黑松林与镇海寺',
    chapterRange: '第 81—83 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_16/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['黑松林', '镇海寺', '白鼠精'],
    ...
    id: 'xiyouji_17',
    title: '第 86—87 回 · 凤仙郡祈雨',
    chapterRange: '第 86—87 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_17/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['凤仙郡', '劝善', '祈雨'],
    ...
    id: 'xiyouji_18',
    title: '第 97—100 回 · 取经功成与封圣',
    chapterRange: '第 97—100 回',
    bookId: 'journey',
    bookLabel: '西游记专题',
    contentType: 'masterpiece',
    isTopic: true,
    ...
    courseware: {
      entry: 'visualizations/books/journey/xiyouji_18/index.html',
      mode: 'embedded-lesson'
    },
    tags: ['真经', '八十一难', '封圣'],
