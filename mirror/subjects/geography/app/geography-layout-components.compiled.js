...
(() => {
  ...
  const PortraitNotice = ({
    ...
    className: "mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full border border-yellow-500/20 bg-yellow-500/10"
  }, /*#__PURE__*/React.createElement("div", {
    className: "relative h-10 w-14"
  }, /*#__PURE__*/React.createElement("div", {
    className: "absolute inset-0 rounded-[14px] border-2 border-yellow-400/90"
  }), /*#__PURE__*/React.createElement("div", {
    className: "absolute left-1/2 top-1/2 h-12 w-8 -translate-x-1/2 -translate-y-1/2 rotate-90 rounded-[10px] border-2 border-yellow-400/35"
  }))), /*#__PURE__*/React.createElement("div", {
    className: "text-[12px] tracking-[0.32em] text-zinc-500 uppercase mb-4"
  }, "\u4EC5\u9650\u6A2A\u5C4F\u6A21\u5F0F"), /*#__PURE__*/React.createElement("h2", {
    className: "text-3xl font-black italic tracking-tight text-yellow-400 mb-3 break-words"
  ...
  const LandscapeOnlyViewport = ({
    ...
    const backgroundSrc = resolveGeographyMediaThumbnailPath(backgroundImage, 'assets/bg_j.webp', {
      width: 1920
    });
  ...
  const CoursewareWorkbench = ({
    ...
    return /*#__PURE__*/React.createElement(LandscapeOnlyViewport, {
      ...
      const asideWidth = isStacked ? frame.width : usesScenePanel && isTinyLandscape ? Math.max(240, Math.min(276, Math.round(frame.width * 0.31))) : frame.coursewareAsideWidth;
      ...
      return /*#__PURE__*/React.createElement("div", {
      ...
      }, /*#__PURE__*/React.createElement("style", null, SCENE_PANEL_READOUT_CSS), /*#__PURE__*/React.createElement("header", {
        ...
        style: {
          gap: `${headerGap}px`,
          maxWidth: isStacked ? '100%' : 'calc(100% - 160px)'
        }
      ...
      }, "\u8FD4\u56DE\u5217\u8868"), !isStacked ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
        className: "h-7 w-[1px] bg-white/10 shrink-0"
      }), /*#__PURE__*/React.createElement("div", {
        className: "min-w-0 max-w-[980px]"
      }, /*#__PURE__*/React.createElement("div", {
        className: `font-black italic tracking-tight text-yellow-400 truncate ${isTinyLandscape ? 'text-[18px]' : frame.ultraWide ? 'text-[36px]' : frame.roomy ? 'text-[32px]' : frame.dense ? 'text-[24px]' : 'text-[30px]'}`
        ...
        className: `${isStacked || isTinyLandscape ? 'hidden' : 'flex'} items-center gap-2.5 opacity-60`
      }, /*#__PURE__*/React.createElement("div", {
        className: "w-5 h-5 rounded border border-yellow-500/40 bg-yellow-500/5 flex items-center justify-center"
      }, /*#__PURE__*/React.createElement("span", {
        className: "text-yellow-400 font-black text-[10px]"
      }, "\u5730")), /*#__PURE__*/React.createElement("span", {
        className: "text-[10px] font-black tracking-widest text-white/40 uppercase"
      }, "PowerTech在线教学演示")))), /*#__PURE__*/React.createElement("main", {
        ...
        className: "w-6 h-6 rounded-full border border-yellow-400/20 bg-yellow-500/10 text-yellow-300 text-[11px] font-black flex items-center justify-center shrink-0"
        ...
        className: "text-[10px] tracking-[0.3em] text-yellow-400 uppercase mb-3"
        ...
        className: "text-[10px] tracking-[0.3em] text-yellow-300 uppercase mb-4"
        ...
        className: "w-1.5 h-1.5 rounded-full bg-yellow-300 mt-2 shrink-0"
      }), /*#__PURE__*/React.createElement("div", {
  ...
  const CardTile = React.memo(({
    ...
    return /*#__PURE__*/React.createElement("button", {
      ...
      className: `group relative overflow-hidden appearance-none bg-transparent text-left transition-all duration-700 ${card.isLocked ? 'cursor-not-allowed opacity-80' : 'cursor-pointer'} border backdrop-blur-md focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yellow-300/80 ${isActive ? 'z-20 border-yellow-400/60 bg-yellow-500/15 -translate-y-2 scale-[1.02] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.8),0_0_30px_rgba(234,179,8,0.25)]' : 'z-0 border-white/10 bg-zinc-900/40'} ${cardHeightClass} ${tileShellClass}`,
      style: {
        touchAction: 'manipulation',
        WebkitTapHighlightColor: 'transparent'
      }
      ...
      src: resolveGeographyMediaThumbnailPath(card.image, card.fallbackImage || 'assets/geography_card_bg_golden.webp', {
        width: 720
      }),
      ...
      className: `${levelClass} font-black uppercase transition-colors duration-500 ${isActive ? 'text-yellow-400' : card.isLocked ? 'text-zinc-500' : 'text-yellow-500'}`
      ...
      className: `${titleSize} font-black italic text-white transition-all duration-500 leading-tight break-words line-clamp-2 ${titleMarginClass} ${isActive ? 'text-yellow-300' : card.isLocked ? 'text-zinc-400' : ''}`
    }, card.title), /*#__PURE__*/React.createElement("div", {
      ...
      className: `text-[10px] font-black tracking-widest ${card.isLocked ? 'text-zinc-500' : 'text-yellow-500'}`
      ...
      className: `absolute -inset-x-20 top-0 h-px bg-gradient-to-r from-transparent via-yellow-500/50 to-transparent transition-transform duration-1000 transform ${isActive ? 'translate-x-full' : '-translate-x-full'}`
    }));
  });
