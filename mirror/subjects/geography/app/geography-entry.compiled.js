...
(() => {
  ...
  const GEOGRAPHY_FEEDBACK_TYPES = Object.freeze([Object.freeze({
    id: 'bug',
    label: '问题反馈',
  ...
  function buildUnifiedGeographyHref(reason, options = {}) {
    try {
      const baseHref = typeof getUnifiedPortalHref === 'function' ? getUnifiedPortalHref(reason, GEOGRAPHY_SUBJECT_KEY) : new URL('/', window.location.href).toString();
  ...
  function GeographyAccessPrompt({
    title,
    description,
    actionHref,
    actionLabel
    ...
    return /*#__PURE__*/React.createElement("div", {
      className: "rounded-[24px] border border-yellow-400/14 bg-yellow-500/[0.06] p-5"
    }, /*#__PURE__*/React.createElement("div", {
      className: "text-sm font-black tracking-[0.14em] text-yellow-100"
  ...
  function GeographyAnnouncementCenter({
    enabled,
    loginHref
  }) {
    ...
    if (!enabled) {
      return /*#__PURE__*/React.createElement("section", {
        ...
        className: "text-[10px] font-black uppercase tracking-[0.3em] text-yellow-300/85"
      }, "\u516C\u544A\u4E2D\u5FC3"), /*#__PURE__*/React.createElement("div", {
        className: "mt-3"
      }, /*#__PURE__*/React.createElement(GeographyAccessPrompt, {
        title: "\u767B\u5F55\u540E\u67E5\u770B\u4E13\u5C5E\u516C\u544A",
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      return /*#__PURE__*/React.createElement("button", {
        ...
        className: `w-full rounded-[22px] border px-4 py-4 text-left transition-all ${isActive ? 'border-yellow-400/20 bg-yellow-500/[0.10]' : 'border-white/10 bg-white/[0.03] hover:bg-white/[0.05]'}`
      }, /*#__PURE__*/React.createElement("div", {
        className: "flex items-center justify-between gap-3"
      }, /*#__PURE__*/React.createElement("div", {
        className: "truncate text-sm font-black text-white"
      }, getGeographyAnnouncementTitle(item)), !item?.is_read ? /*#__PURE__*/React.createElement("span", {
      ...
      }, getGeographyAnnouncementBody(item)), /*#__PURE__*/React.createElement("div", {
    ...
    }, getGeographyAnnouncementTitle(selectedAnnouncement)), /*#__PURE__*/React.createElement("span", {
  ...
  function GeographyFeedbackCenter({
    enabled,
    loginHref
  }) {
    ...
    return /*#__PURE__*/React.createElement("section", {
      ...
      className: `rounded-[14px] px-4 py-2 text-sm font-black transition-all ${activeSection === item.key ? 'bg-yellow-400 text-black' : 'text-white/62 hover:text-white'}`
    }, item.label))), feedbackText ? /*#__PURE__*/React.createElement("div", {
      className: `mt-4 rounded-[20px] border px-4 py-4 text-sm leading-7 ${feedbackTone === 'success' ? 'border-yellow-400/18 bg-yellow-500/[0.08] text-yellow-50' : feedbackTone === 'error' ? 'border-rose-400/18 bg-rose-500/[0.08] text-rose-50' : 'border-white/10 bg-white/[0.04] text-white/76'}`
    ...
    }, GEOGRAPHY_FEEDBACK_TYPES.map(item => /*#__PURE__*/React.createElement("button", {
      key: item.id,
      type: "button",
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        className: "mt-4 rounded-[18px] border border-yellow-400/14 bg-yellow-500/[0.06] px-4 py-4"
      }, /*#__PURE__*/React.createElement("div", {
        className: "text-[11px] font-black tracking-[0.12em] text-yellow-100"
  ...
  function DashboardOverlayShell({
    ...
    return /*#__PURE__*/React.createElement("div", {
      ...
      className: "text-[10px] font-black uppercase tracking-[0.34em] text-yellow-300/90"
  ...
  function App() {
    ...
    const landingBackgroundPool = useMemo(() => unique(['assets/bg_j.webp', 'assets/bg_s.webp', ...Object.values(BOOK_BACKGROUND_MAP || {})]), []);
    const [landingImageBackground, setLandingImageBackground] = useState(() => {
      const pool = unique(['assets/bg_j.webp', 'assets/bg_s.webp', ...Object.values(BOOK_BACKGROUND_MAP || {})]);
    ...
    const unifiedPayload = typeof useUnifiedSubjectBootstrap === 'function' ? useUnifiedSubjectBootstrap(GEOGRAPHY_SUBJECT_KEY) : null;
    ...
    useEffect(() => {
      let ignore = false;
      (async () => {
        const [course, manifest, engineConfig] = await Promise.all([loadCourseData(), fetchJsonSafe(VISUAL_MANIFEST_PATH), fetchUnifiedGeographyEngineConfig()]);
        if (ignore) return;
        if (!course) {
    ...
    const cards = useMemo(() => {
      ...
      return courseData.currentCardMapping.filter(mapping => {
        return mapping.stageId === stageId && (bookId === 'all' || mapping.bookId === bookId);
      }).map((mapping, index) => {
    ...
    const coursewareSceneEntry = useMemo(() => visualManifest?.cards?.find(item => item.cardId === coursewareCardId) || null, [visualManifest, coursewareCardId]);
    useEffect(() => {
    ...
    const activeBackground = resolveLocalMediaKey(BOOK_BACKGROUND_MAP[bookId] || (stageId === 'junior' ? 'assets/bg_j.webp' : 'assets/bg_s.webp'), stageId === 'junior' ? 'assets/bg_j.webp' : 'assets/bg_s.webp');
    ...
    const profileHref = useMemo(() => buildUnifiedGeographyHref('subject_profile', {
      tab: 'profile'
    }), []);
    ...
    const handleLogout = async () => {
      ...
      try {
        ...
        window.location.href = typeof getUnifiedPortalHref === 'function' ? getUnifiedPortalHref('logout', GEOGRAPHY_SUBJECT_KEY) : '/';
      } finally {
        setLoggingOut(false);
      }
    };
    if (loadError) {
      ...
      }, "Geography Curriculum"), /*#__PURE__*/React.createElement("div", {
    ...
    if (!courseData) {
      ...
      }, "\u5730\u7406\u53EF\u89C6\u5316"), /*#__PURE__*/React.createElement("div", {
      ...
      }, "\u6743\u9650\u6838\u9A8C\u5DF2\u901A\u8FC7\uFF0C\u6B63\u5728\u521D\u59CB\u5316\u5730\u7406\u8BFE\u7A0B\u67B6\u6784\u4E0E\u53EF\u89C6\u5316\u8D44\u6E90\uFF0C\u8BF7\u7A0D\u5019\u3002"), /*#__PURE__*/React.createElement("div", {
    ...
    if (coursewareCard && canOpenCourseware) {
      ...
      }), /*#__PURE__*/React.createElement(GeographyBetaNotice, {
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(LandscapeOnlyViewport, {
      ...
      return /*#__PURE__*/React.createElement("div", {
        ...
        style: {
          background: `radial-gradient(circle at center, rgba(12,18,15,0.7) 0%, rgba(5,5,5,0.95) 100%), url(${resolveGeographyMediaThumbnailPath(activeBackground, 'assets/bg_j.webp', {
            width: 1920
        ...
        className: `${portraitCompact ? 'w-7 h-7' : 'w-8 h-8'} rounded-md border border-yellow-500/60 bg-yellow-500/10 flex items-center justify-center group-hover:bg-yellow-500/20 group-active:bg-yellow-500/25 transition-all`
      }, /*#__PURE__*/React.createElement("span", {
        className: "text-yellow-400 font-black text-[14px] translate-y-[0.5px]"
        ...
        className: `${narrowStack ? 'hidden' : 'flex'} items-center gap-2.5 ${headerMetaClass} font-black text-yellow-500`
        ...
        src: resolveGeographyMediaThumbnailPath(activeCard.image, activeCard.fallbackImage || 'assets/geography_card_bg_golden.webp', {
          width: 1280
        }),
        ...
        className: "w-1.5 h-1.5 bg-yellow-500 rounded-full mt-1.5 shrink-0"
      }), point))), /*#__PURE__*/React.createElement("div", {
        className: `${narrowStack ? 'pt-3' : 'pt-6'} border-t border-white/10 mt-auto`
      }, /*#__PURE__*/React.createElement("h5", {
        className: `text-[9px] font-black text-yellow-400 tracking-widest uppercase ${narrowStack ? 'mb-2' : 'mb-3'}`
      ...
      }, "\u8FDB\u5165\u4EA4\u4E92\u8BFE\u4EF6"))), narrowStack ? /*#__PURE__*/React.createElement("div", {
