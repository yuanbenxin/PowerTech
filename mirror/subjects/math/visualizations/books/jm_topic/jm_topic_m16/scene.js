...
(function () {
  const CARD_ID = "jm_topic_m16";
  const STYLE_ID = "math-spatial-three-view-topic-style";
  const FALLBACK_ERROR = "空间想象与三视图专题课件加载失败，请检查本卡片目录内 source.html、style.css?v=99199b3480d2 与 scene.js?v=a03d28b2f806";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .spatial-three-view-topic-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .spatial-three-view-topic-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column,
  ...
  function topicCoursewareStyle() {
    return `
      ...
      #analysis-hud-card .hud-content p,
      #analysis-hud-card .hud-content li,
      #analysis-hud-card .hud-content em,
      #analysis-hud-card .hud-content .hud-muted {
        color: #334155 !important;
      }
      #analysis-hud-card .hud-content strong,
      #analysis-hud-card .hud-content b {
        color: #0f172a !important;
      }
      #analysis-hud-card .hud-content h3 {
        color: #2563eb !important;
      }
      #analysis-hud-card .hud-example-grid span {
        color: #b45309 !important;
      }
      .source-panel-scroll,
      .spatial-three-view-topic-panel-scroll {
      ...
      .height-control-cell button::before {
        font-size: 16px !important;
        line-height: 1 !important;
      }
      .height-control-cell button:first-child::before {
        content: "+" !important;
      }
      .height-control-cell button:last-child::before {
        content: "−" !important;
      }
      ...
      .canvas-3d-container {
        --spatial-model-scale: 1.22;
      }
      .proj-cell.projection-linked {
        border-color: #facc15 !important;
        box-shadow: inset 0 0 0 2px rgba(250, 204, 21, 0.92), 0 0 12px rgba(250, 204, 21, 0.28) !important;
      }
      .height-control-cell.is-linked {
  ...
  function spatialThreeViewHudFullscreenStyle() {
    return `
      /* SPATIAL_THREE_VIEW_HUD_FULLSCREEN: show the complete teaching note without an inner scrollbar. */
      .analysis-hud,
      .analysis-hud:not(.collapsed),
      .analysis-hud-card,
      .analysis-hud-card:not(.collapsed) {
        top: 12px !important;
        left: 12px !important;
        right: auto !important;
        bottom: auto !important;
        width: min(390px, calc(100% - 24px)) !important;
        max-width: min(390px, calc(100% - 24px)) !important;
        height: auto !important;
        max-height: none !important;
        overflow: visible !important;
      }
      ...
      .analysis-hud .hud-content::-webkit-scrollbar,
      .analysis-hud-card .hud-content::-webkit-scrollbar,
      .analysis-hud .hud-body::-webkit-scrollbar,
      .analysis-hud-card .hud-body::-webkit-scrollbar {
        display: none !important;
      }
      .analysis-hud .hud-content h3,
      .analysis-hud-card .hud-content h3 {
      ...
      .analysis-hud .hud-content h3:first-child,
      .analysis-hud-card .hud-content h3:first-child {
        margin-top: 0 !important;
      }
      .analysis-hud .hud-content p,
      .analysis-hud-card .hud-content p,
      .analysis-hud .hud-content ul,
      .analysis-hud-card .hud-content ul,
      .analysis-hud .hud-content li,
      .analysis-hud-card .hud-content li {
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("spatial-three-view-topic-scene");
    ...
    const panel = makeShadowHost("spatial-three-view-topic-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "spatial-three-view-topic-panel-scroll";
  ...
  function runSourceScript(script, sceneRoot, panelRoot, sceneHost, cleanup) {
    ...
    const runner = new Function(
      ...
      "katex",
      "renderMathInElement",
      `"use strict";\n${source}\n//# sourceURL=jm_topic_m16_source.js`
    );
    runner(
      scopedDocument,
      scopedWindow,
  ...
  window.MATH_VISUAL_SCENES[CARD_ID] = {
    async mount(container, context) {
      ...
      try {
        ...
        console.error("Failed to mount spatial-three-view-topic card:", error);
