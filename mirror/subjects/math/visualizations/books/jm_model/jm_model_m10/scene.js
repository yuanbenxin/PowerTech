...
(function () {
  const CARD_ID = "jm_model_m10";
  const STYLE_ID = "math-eight-shape-similarity-model-style";
  const FALLBACK_ERROR = "8 字型相似模型课件载入失败，请检查本卡片目录内 source.html、style.css?v=5a23b6fce1a3 与 scene.js?v=947164018fb6";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .eight-shape-similarity-model-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .eight-shape-similarity-model-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column {
      ...
      /* 统一深色操作面板：互动方式、相似比和构型预设保持与其他模型一致的高对比度。 */
      .panel-section h3,
      .theory-card h3 {
        color: #f8fafc !important;
      ...
      .btn-interaction-mode {
        ...
        border: 1px solid rgba(100, 116, 139, 0.52) !important;
        border-radius: 7px !important;
      ...
      .btn-interaction-mode:hover {
        border-color: #67e8f9 !important;
        background: rgba(8, 145, 178, 0.16) !important;
        color: #ecfeff !important;
      }
      .btn-interaction-mode.active {
      ...
      .btn-shape-preset:hover,
      .btn-shape-preset.active {
        border-color: #67e8f9 !important;
      ...
      .teaching-route-card {
        ...
        gap: 8px !important;
        padding: 10px !important;
        border: 1px solid rgba(100, 116, 139, 0.46) !important;
        border-radius: 8px !important;
        background: #0f172a !important;
      }
      .teaching-route-title {
        color: #67e8f9 !important;
        font-size: 12px !important;
      ...
      .teaching-route-step b {
        display: block !important;
        color: #f8fafc !important;
        font-size: 12px !important;
        line-height: 1.35 !important;
      }
      .teaching-route-step em {
        display: block !important;
      ...
      .teaching-route-alert b {
        color: #fde68a !important;
        font-size: 12px !important;
      }
      .teaching-route-alert span {
        color: #fef3c7 !important;
        font-size: 11px !important;
        line-height: 1.45 !important;
      }
      ...
      .geo-point {
        ...
        transition: fill 0.2s, stroke 0.2s, filter 0.2s !important;
        filter: drop-shadow(0 2px 4px rgba(15, 23, 42, 0.22)) !important;
      }
      .geo-point-wrapper[data-point-id="A"] .geo-point {
        fill: #111827 !important;
      }
      .geo-point-wrapper[data-point-id="B"] .geo-point,
      .geo-point-wrapper[data-point-id="C"] .geo-point {
        fill: #2563eb !important;
      }
      .geo-point-wrapper[data-point-id="D"] .geo-point,
      .geo-point-wrapper[data-point-id="E"] .geo-point {
      ...
      .geo-point-wrapper[data-point-id="D"] .geo-point-halo,
      .geo-point-wrapper[data-point-id="E"] .geo-point-halo {
        fill: rgba(245, 158, 11, 0.18) !important;
      }
      .geo-point-wrapper:hover .geo-point {
        transform: none !important;
        stroke-width: 4px !important;
        filter: drop-shadow(0 0 8px rgba(59, 130, 246, 0.34)) !important;
      }
      .geo-triangle-patch.patch-main {
        fill: rgba(59, 130, 246, 0.14) !important;
        stroke: rgba(37, 99, 235, 0.36) !important;
      }
      .geo-triangle-patch.patch-inner {
        fill: rgba(245, 158, 11, 0.18) !important;
        stroke: rgba(217, 119, 6, 0.45) !important;
      }
      .geo-triangle-patch.patch-rotated {
        fill: rgba(139, 92, 246, 0.16) !important;
        stroke: rgba(124, 58, 237, 0.42) !important;
      }
      .geo-polygon-fill.triangle-main {
        fill: rgba(59, 130, 246, 0.13) !important;
        stroke: rgba(37, 99, 235, 0.35) !important;
        stroke-width: 1.5px !important;
      }
      .geo-polygon-fill.triangle-match {
        fill: rgba(245, 158, 11, 0.14) !important;
        stroke: rgba(217, 119, 6, 0.34) !important;
        stroke-width: 1.5px !important;
      }
      .geo-polygon-fill.demo-hot-fill {
        fill-opacity: 0.28 !important;
        filter: drop-shadow(0 8px 20px rgba(59, 130, 246, 0.14)) !important;
      }
      ...
      .geo-equal-tick.mark-blue {
        stroke: #2563eb !important;
      }
      .geo-equal-tick.mark-purple {
        stroke: #7c3aed !important;
      }
      .geo-equal-tick.mark-green {
        stroke: #059669 !important;
      }
      .geo-equal-tick.mark-orange {
        stroke: #d97706 !important;
      }
      .geo-equal-tick.demo-hot {
        stroke-width: 5px !important;
        filter: drop-shadow(0 0 7px rgba(245, 158, 11, 0.35)) !important;
      }
      .geo-angle-arc.demo-hot,
      .geo-angle-sector.demo-hot {
        filter: drop-shadow(0 0 8px rgba(245, 158, 11, 0.36)) !important;
      }
      .geo-line-seg.demo-hot-line {
        stroke-width: 7px !important;
        filter: drop-shadow(0 0 9px rgba(245, 158, 11, 0.32)) !important;
      }
      .geo-angle-badge {
        fill: #111827 !important;
      ...
      .geo-angle-badge.pair-blue {
        fill: #2563eb !important;
      }
      .geo-angle-badge.pair-orange {
        fill: #d97706 !important;
      }
      .geo-angle-badge.pair-common {
      ...
      .brace-label.ratio-left,
      .brace-label.ratio-right {
        min-width: 104px !important;
        text-align: center !important;
        font-size: 12px !important;
        padding: 3px 8px !important;
      }
      .brace-label.ratio-center {
        font-size: 12px !important;
      ...
      .geo-point-wrapper.draggable .geo-point-halo {
        opacity: 0.32 !important;
        fill: rgba(59, 130, 246, 0.18) !important;
      }
      .sandbox-container.dragging-point,
      .sandbox-container.dragging-point .geo-point-wrapper.draggable,
      .sandbox-container.dragging-point .geo-point-wrapper.draggable * {
        cursor: grabbing !important;
      }
      .sandbox-container.dragging-point .geo-point-wrapper.draggable-point .geo-point {
        filter: drop-shadow(0 0 12px rgba(59, 130, 246, 0.45)) !important;
      }
      input[type="range"] {
        accent-color: #facc15;
      }
...
${unifiedJmModelHudFinalOverrides()}`;
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("eight-shape-similarity-model-scene");
    ...
    const panel = makeShadowHost("eight-shape-similarity-model-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "eight-shape-similarity-model-panel-scroll";
  ...
  function runSourceScript(script, sceneRoot, panelRoot, sceneHost, cleanup) {
    ...
    const runner = new Function(
      ...
      "clearInterval",
      "CSS",
      `"use strict";\n${source}\n//# sourceURL=jm_model_m10_source.js`
    );
    runner(
      scopedDocument,
      scopedWindow,
  ...
  window.MATH_VISUAL_SCENES[CARD_ID] = {
    async mount(container, context) {
      ...
      try {
        ...
        console.error("Failed to mount 8-shape similarity model card:", error);
