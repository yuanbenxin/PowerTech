...
(function () {
  const CARD_ID = "jm_model_m07";
  const STYLE_ID = "math-angle-bisector-double-perpendicular-model-style";
  const FALLBACK_ERROR = "角平分线双垂线模型课件载入失败，请检查本卡片目录内 source.html、style.css?v=365d13513cb9 与 scene.js?v=ad2d1d31f86d";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .angle-bisector-double-perpendicular-model-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .angle-bisector-double-perpendicular-model-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column {
      ...
      @media (pointer: coarse), (hover: none), (max-width: 768px) {
        ...
        .geo-point-wrapper.draggable .geo-point {
          r: 7px !important;
        }
        .angle-bisector-double-perpendicular-model-panel-scroll .btn-preset,
        .angle-bisector-double-perpendicular-model-panel-scroll .btn-primary,
        .angle-bisector-double-perpendicular-model-panel-scroll .btn-secondary,
        .angle-bisector-double-perpendicular-model-panel-scroll .btn-icon,
        .angle-bisector-double-perpendicular-model-panel-scroll #btn-play-folding,
        .angle-bisector-double-perpendicular-model-panel-scroll #btn-reset-state,
        .angle-bisector-double-perpendicular-model-panel-scroll #btn-show-help,
        .angle-bisector-double-perpendicular-model-panel-scroll #btn-close-help {
        ...
        .angle-bisector-double-perpendicular-model-panel-scroll input[type="range"] {
          min-height: 44px !important;
          touch-action: manipulation !important;
        }
        .angle-bisector-double-perpendicular-model-panel-scroll input[type="range"]::-webkit-slider-thumb {
          width: 28px !important;
          height: 28px !important;
        }
        #hint-keyboard {
...
${unifiedJmModelHudFinalOverrides()}`;
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("angle-bisector-double-perpendicular-model-scene");
    ...
    const panel = makeShadowHost("angle-bisector-double-perpendicular-model-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "angle-bisector-double-perpendicular-model-panel-scroll";
  ...
  function runSourceScript(script, sceneRoot, panelRoot, sceneHost, cleanup) {
    ...
    const runner = new Function(
      ...
      "clearInterval",
      "CSS",
      `"use strict";\n${source}\n//# sourceURL=jm_model_m07_source.js`
    );
    runner(
      scopedDocument,
      scopedWindow,
  ...
  window.MATH_VISUAL_SCENES[CARD_ID] = {
    async mount(container, context) {
      ...
      try {
        ...
        console.error("Failed to mount angle-bisector double perpendicular model card:", error);
