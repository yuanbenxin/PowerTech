...
(function () {
  const CARD_ID = "j7b_m07";
  const STYLE_ID = "math-irrational-root-location-style";
  const FALLBACK_ERROR = "无理数逼近与根号定位课件加载失败，请检查本卡片目录内 source.html、style.css?v=8062096183dc 与 scene.js?v=0b42dc5631e8";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .irrational-root-location-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .irrational-root-location-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column,
  ...
  function panelUnifiedStyle() {
    return `
      :host(.irrational-root-location-panel) .control-column,
      :host(.irrational-root-location-panel) .control-panel,
      :host(.irrational-root-location-panel) .irrational-root-location-panel-scroll .control-column {
        display: grid !important;
        grid-auto-rows: min-content !important;
        gap: 8px !important;
        padding: 10px !important;
      ...
      :host(.irrational-root-location-panel) .control-column .presets-grid {
        display: grid !important;
        grid-template-columns: minmax(0, 1fr) !important;
        gap: 8px !important;
        width: 100% !important;
      }
      :host(.irrational-root-location-panel) .presets-grid,
      :host(.irrational-root-location-panel) .presets-btn-list,
      :host(.irrational-root-location-panel) .sliders-container {
        display: grid !important;
        grid-template-columns: 1fr !important;
        gap: 8px !important;
        width: 100% !important;
      }
      :host(.irrational-root-location-panel) .presets-grid > .btn-preset {
        width: 100% !important;
        max-width: 100% !important;
      }
      :host(.irrational-root-location-panel) .btn-preset {
        width: 100% !important;
      ...
      :host(.irrational-root-location-panel) .btn-preset .preset-num {
        grid-row: 1 / span 2 !important;
        width: 26px !important;
        height: 26px !important;
        display: grid !important;
      ...
      :host(.irrational-root-location-panel) .btn-preset .preset-name {
        display: block !important;
        min-width: 0 !important;
        font-size: 13px !important;
        line-height: 1.25 !important;
      ...
      :host(.irrational-root-location-panel) .btn-preset .preset-desc {
        display: block !important;
        min-width: 0 !important;
        font-size: 11px !important;
        line-height: 1.35 !important;
      ...
      :host(.irrational-root-location-panel) .btn-preset.active::after {
        content: "" !important;
        position: absolute !important;
        left: 0 !important;
        top: 0 !important;
      ...
      :host(.irrational-root-location-panel) .btn-preset-problem,
      :host(.irrational-root-location-panel) .btn-secondary,
      :host(.irrational-root-location-panel) .btn-control-action,
      :host(.irrational-root-location-panel) select {
        width: 100% !important;
        min-width: 0 !important;
        border-radius: 8px !important;
        border: 1px solid rgba(148, 163, 184, 0.18) !important;
      ...
      :host(.irrational-root-location-panel) .control-column .btn-preset.active,
      :host(.irrational-root-location-panel) .btn-preset.active,
      :host(.irrational-root-location-panel) .btn-control-action.active-run,
      :host(.irrational-root-location-panel) .btn-control-action.active-orange,
      :host(.irrational-root-location-panel) .btn-control-action.active-blue {
        border-color: rgba(250, 204, 21, 0.42) !important;
        background: rgba(250, 204, 21, 0.12) !important;
        color: #fef3c7 !important;
      }
      :host(.irrational-root-location-panel) .btn-preset.active .preset-num {
        background: rgba(250, 204, 21, 0.88) !important;
        color: #111827 !important;
      }
      :host(.irrational-root-location-panel) .btn-preset.active .preset-name {
        color: #fef3c7 !important;
      }
      :host(.irrational-root-location-panel) .btn-preset.active .preset-desc {
        color: rgba(254, 243, 199, 0.82) !important;
      }
      :host(.irrational-root-location-panel) .slider-row .scene-range-slider {
        background: transparent !important;
        accent-color: #3b82f6 !important;
        appearance: none !important;
        -webkit-appearance: none !important;
      }
      :host(.irrational-root-location-panel) .slider-row .scene-range-slider::-webkit-slider-thumb,
      :host(.irrational-root-location-panel) .slider-row .scene-range-slider::-moz-range-thumb {
        background: #3b82f6 !important;
        border: 0 !important;
      }
      :host(.irrational-root-location-panel) .control-action-btn-group {
        display: grid !important;
  ...
  function ultimateHudStandardStyle() {
    return `
      #hud-chalkboard-panel.hud-panel,
      #hud-chalkboard-panel.hud-panel.expanded,
      #hud-chalkboard-panel.hud-panel:not(.collapsed),
      ...
      .hud-summary-card {
        ...
        border: 1px solid rgba(148, 163, 184, 0.16) !important;
        border-radius: 12px !important;
        background: linear-gradient(180deg, rgba(248, 250, 252, 0.96), rgba(255, 255, 255, 0.96)) !important;
      ...
      .hud-summary-note {
        ...
        border-top: 1px dashed rgba(148, 163, 184, 0.24) !important;
        color: #475569 !important;
        font-size: 12px !important;
        line-height: 1.38 !important;
      }
      ...
      .hud-formula-step {
        ...
        grid-template-areas: "idx expr" "idx result" !important;
        align-items: center !important;
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("irrational-root-location-scene");
    ...
    const panel = makeShadowHost("irrational-root-location-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "irrational-root-location-panel-scroll";
  ...
  function bridgeHudTouchToggle(sceneRoot, cleanup) {
    const hudTriggerSelector = "#hud-toggle-btn, .hud-header, .hud-control-btn";
    const onHudTouchEnd = event => {
      const target = event.target?.closest?.(hudTriggerSelector);
      const hud = target?.closest?.("#hud-chalkboard-panel");
      if (!target || !hud || !sceneRoot.contains(hud)) return;
      const hudToggle = hud.querySelector("#hud-toggle-btn") || target;
