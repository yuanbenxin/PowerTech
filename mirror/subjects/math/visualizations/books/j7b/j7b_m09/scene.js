...
(function () {
  const CARD_ID = "j7b_m09";
  const STYLE_ID = "math-linear-system-elimination-style";
  const FALLBACK_ERROR = "消元法解二元一次方程组课件加载失败，请检查本卡片目录内 source.html、style.css?v=4513cf0a63dc 与 scene.js?v=0e13bd130832";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .linear-system-elimination-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .linear-system-elimination-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column,
      ...
      .hud-panel.collapsed .hud-title::before {
        ...
        border-radius: 999px !important;
        background: conic-gradient(from 0deg, #38bdf8, #f59e0b, #22c55e, #38bdf8) !important;
  ...
  function topicCoursewareStyle() {
    return `
      ...
      .analysis-hud-card {
        ...
        max-height: min(390px, calc(100% - 28px)) !important;
        overflow: hidden !important;
        border-radius: 14px !important;
        border: 1px solid rgba(148, 163, 184, 0.24) !important;
        background: rgba(255, 255, 255, 0.94) !important;
      ...
      #steps-hud-chalkboard {
        max-height: calc(min(390px, calc(100vh - 120px)) - 44px) !important;
      ...
      .scene-presets-stack > .btn-preset,
      .presets-grid > .btn-preset {
        width: 100% !important;
        max-width: 100% !important;
        flex: 0 0 auto !important;
      }
      ...
      input[type="range"]:not(.scene-range-slider) {
        width: 100% !important;
        min-height: 34px !important;
        cursor: pointer !important;
      ...
      .slider-row .slider-val-indicator {
        display: inline-flex !important;
        align-items: center !important;
        justify-content: center !important;
      ...
      .slider-row .scene-range-slider::-webkit-slider-runnable-track {
        height: 6px !important;
        border-radius: 999px !important;
        background: linear-gradient(
          90deg,
          #3b82f6 0%,
          #3b82f6 var(--slider-pct, 0%),
          rgba(148, 163, 184, 0.22) var(--slider-pct, 0%),
          rgba(148, 163, 184, 0.22) 100%
        ) !important;
        box-shadow: inset 0 0 0 1px rgba(255, 255, 255, 0.06) !important;
      }
      .slider-row .scene-range-slider::-webkit-slider-thumb {
        width: 18px !important;
        height: 18px !important;
      ...
      .slider-row .scene-range-slider::-moz-range-track {
        height: 6px !important;
        border: 0 !important;
        border-radius: 999px !important;
        background: rgba(148, 163, 184, 0.22) !important;
      }
      .slider-row .scene-range-slider::-moz-range-progress {
        height: 6px !important;
        border-radius: 999px !important;
        background: #3b82f6 !important;
      }
      .slider-row .scene-range-slider::-moz-range-thumb {
        width: 18px !important;
        height: 18px !important;
        border: 0 !important;
        border-radius: 50% !important;
      ...
      .hud-theory-block p:last-child {
        margin-bottom: 0 !important;
      }
      .hud-theory-block strong {
        color: #0f172a !important;
        font-weight: 700 !important;
      }
      .timeline-container {
      ...
      @media (pointer: coarse), (hover: none), (max-width: 768px) {
        ...
        :host(.is-touch-courseware) .scene-presets-stack,
  ...
  function unifiedHudBoardStyle() {
    return `
      ...
      #hud-chalkboard-panel .hud-title::before,
  ...
  function panelUnifiedStyle() {
    return `
      :host(.linear-system-elimination-panel) .control-column,
      :host(.linear-system-elimination-panel) .control-panel,
      :host(.linear-system-elimination-panel) .linear-system-elimination-panel-scroll .control-column {
        display: grid !important;
        grid-auto-rows: min-content !important;
        gap: 8px !important;
        padding: 10px !important;
      ...
      :host(.linear-system-elimination-panel) .presets-grid,
      :host(.linear-system-elimination-panel) .scene-presets-stack,
      :host(.linear-system-elimination-panel) .presets-btn-list,
      :host(.linear-system-elimination-panel) .sliders-container {
        display: flex !important;
        flex-direction: column !important;
        flex-wrap: nowrap !important;
        align-items: stretch !important;
      ...
      :host(.linear-system-elimination-panel) .scene-presets-stack > .btn-preset,
      :host(.linear-system-elimination-panel) .presets-grid > .btn-preset {
        width: 100% !important;
        max-width: 100% !important;
        flex: 0 0 auto !important;
      }
      :host(.linear-system-elimination-panel) .btn-preset {
        width: 100% !important;
        min-height: 42px !important;
        display: flex !important;
        align-items: center !important;
      ...
      :host(.linear-system-elimination-panel) .btn-preset .preset-num {
        width: 26px !important;
        height: 26px !important;
        display: grid !important;
      ...
      :host(.linear-system-elimination-panel) .btn-preset .preset-name {
        flex: 1 1 auto !important;
        min-width: 0 !important;
        font-size: 12.5px !important;
        line-height: 1.25 !important;
      ...
      :host(.linear-system-elimination-panel) .btn-preset .preset-desc,
      :host(.linear-system-elimination-panel) .btn-preset .preset-copy {
        display: none !important;
      }
      :host(.linear-system-elimination-panel) .btn-preset-problem,
      :host(.linear-system-elimination-panel) .btn-secondary,
      :host(.linear-system-elimination-panel) .btn-control-action {
        width: 100% !important;
        min-width: 0 !important;
        border-radius: 8px !important;
        border: 1px solid rgba(148, 163, 184, 0.18) !important;
      ...
      :host(.linear-system-elimination-panel) .btn-preset.active,
      :host(.linear-system-elimination-panel) .btn-control-action.active-run,
      :host(.linear-system-elimination-panel) .btn-control-action.active-orange,
      :host(.linear-system-elimination-panel) .btn-control-action.active-blue {
        border-color: rgba(250, 204, 21, 0.42) !important;
        background: rgba(250, 204, 21, 0.12) !important;
        color: #fef3c7 !important;
      }
      :host(.linear-system-elimination-panel) .btn-preset.active .preset-num {
        background: rgba(250, 204, 21, 0.88) !important;
        color: #111827 !important;
      }
      :host(.linear-system-elimination-panel) .btn-preset.active .preset-name {
        color: #fef3c7 !important;
      }
      :host(.linear-system-elimination-panel) .btn-preset.active .preset-desc {
        color: rgba(254, 243, 199, 0.82) !important;
      }
      :host(.linear-system-elimination-panel) .slider-row input[type="range"]:not(.scene-range-slider) {
        background: transparent !important;
      }
      :host(.linear-system-elimination-panel) .slider-row .scene-range-slider {
        background: transparent !important;
        accent-color: #3b82f6 !important;
        appearance: none !important;
        -webkit-appearance: none !important;
      }
      :host(.linear-system-elimination-panel) .slider-row .scene-range-slider::-webkit-slider-thumb,
      :host(.linear-system-elimination-panel) .slider-row .scene-range-slider::-moz-range-thumb {
        background: #3b82f6 !important;
        border: 0 !important;
      }
      :host(.linear-system-elimination-panel) .control-action-btn-group {
        display: grid !important;
        grid-template-columns: 1fr 1fr !important;
        gap: 8px !important;
      }
      :host(.linear-system-elimination-panel) #btn-step-replay {
        grid-column: 1 / -1 !important;
      }
      :host(.linear-system-elimination-panel) .target-toggle {
        display: grid !important;
        grid-template-columns: 1fr 1fr !important;
        gap: 8px !important;
        margin-top: 8px !important;
      }
      :host(.linear-system-elimination-panel) .btn-sub-toggle {
        min-height: 38px !important;
        border-radius: 8px !important;
        border: 1px solid rgba(148, 163, 184, 0.18) !important;
        background: rgba(2, 6, 23, 0.36) !important;
      ...
      :host(.linear-system-elimination-panel) .btn-sub-toggle.active {
        border-color: rgba(250, 204, 21, 0.48) !important;
        background: rgba(250, 204, 21, 0.18) !important;
        color: #fef3c7 !important;
      }
      :host(.linear-system-elimination-panel) .advanced-controls {
        margin-top: 8px !important;
        border: 1px solid rgba(148, 163, 184, 0.14) !important;
        border-radius: 8px !important;
        background: rgba(2, 6, 23, 0.24) !important;
      ...
      :host(.linear-system-elimination-panel) .advanced-controls summary {
        min-height: 36px !important;
        display: flex !important;
        align-items: center !important;
        padding: 8px 10px !important;
      ...
      :host(.linear-system-elimination-panel) .advanced-note {
  ...
  function ultimateModelStyle() {
    return `
      ...
      .model-stage {
        width: min(720px, calc(100% - 80px)) !important;
      }
      .model-title-chip,
      .equation-card,
      .result-card,
      ...
      @media (max-width: 720px), (max-height: 560px) {
        ...
        #hud-chalkboard-panel .hud-header::before,
        #hud-toggle-btn::before {
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("linear-system-elimination-scene");
    ...
    const panel = makeShadowHost("linear-system-elimination-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "linear-system-elimination-panel-scroll";
  ...
  function installTouchEnhancements(sceneRoot, panelRoot, cleanup) {
    ...
    const syncPointTargets = () => {
      sceneRoot.querySelectorAll(".geo-point-halo").forEach(node => node.setAttribute("r", touchLike ? "24" : "18"));
      sceneRoot.querySelectorAll(".geo-point").forEach(node => node.setAttribute("r", touchLike ? "8" : "6.5"));
    };
    syncPointTargets();
    const pointObserver = new MutationObserver(syncPointTargets);
    pointObserver.observe(sceneRoot, { childList: true, subtree: true, attributes: true });
  ...
  window.MATH_VISUAL_SCENES[CARD_ID] = {
    async mount(container, context) {
      ...
      try {
        ...
        console.error("Failed to mount linear-system-elimination card:", error);
