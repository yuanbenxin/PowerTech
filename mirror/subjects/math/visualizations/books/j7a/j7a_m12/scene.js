...
(function () {
  const CARD_ID = "j7a_m12";
  const STYLE_ID = "math-angle-complement-bearing-style";
  const FALLBACK_ERROR = "余角补角与方位角课件载入失败，请检查本卡片目录内 source.html、style.css?v=51f982eb240b 与 scene.js?v=7eb63a4cd6bc";
  ...
  function baseStyleText() {
    return `
      ...
      *::after {
      ...
      .angle-complement-bearing-panel-scroll {
        width: 100%;
        height: 100%;
        min-height: 0;
        overflow-x: hidden;
      ...
      .angle-complement-bearing-panel-scroll::-webkit-scrollbar {
        width: 0;
        height: 0;
      }
      .control-column {
  ...
  function unifiedHudBoardStyle() {
    return `
      ...
      #hud-chalkboard-panel .hud-board-title {
        font-size: 12.5px !important;
        line-height: 1.2 !important;
        margin-bottom: 6px !important;
      ...
      #hud-chalkboard-panel .hud-equation-line {
        display: grid !important;
      ...
      #hud-chalkboard-panel .hud-equation-line span {
        color: #334155 !important;
        font-weight: 750 !important;
      }
      #hud-chalkboard-panel .hud-equation-line strong {
        font-size: 14px !important;
        color: #1d4ed8 !important;
      }
      #hud-chalkboard-panel .hud-proof-line,
      #hud-chalkboard-panel .hud-conclusion {
        font-size: 11.5px !important;
  ...
  function extractLayout(body, sourceStyle, cleanup) {
    ...
    const scene = makeShadowHost("angle-complement-bearing-scene");
    ...
    const panel = makeShadowHost("angle-complement-bearing-panel");
    const panelShell = document.createElement("div");
    panelShell.className = "angle-complement-bearing-panel-scroll";
  ...
  window.MATH_VISUAL_SCENES[CARD_ID] = {
    async mount(container, context) {
      ...
      try {
        ...
        console.error("Failed to mount angle complement bearing card:", error);
